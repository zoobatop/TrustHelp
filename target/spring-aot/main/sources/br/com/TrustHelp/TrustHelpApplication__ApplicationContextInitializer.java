 ...
 */
@Generated
public class TrustHelpApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TrustHelpApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TrustHelpApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
